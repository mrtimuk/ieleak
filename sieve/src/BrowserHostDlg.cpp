...
CBrowserHostDlg::CBrowserHostDlg(CComObject<JSHook>* hook, UINT explorerCtrlID, UINT nIDTemplate, CWnd* pParent /*=NULL*/)
	...
	AFX_EVENTSINKMAP_ENTRY templateEventSink[] = {
		...
		ON_EVENT(CBrowserHostDlg, explorerCtrlID, DISPID_WINDOWCLOSING, CBrowserHostDlg::Event_WindowClosing, VTS_PDISPATCH VTS_PBOOL)	
		//		ON_EVENT(CBrowserHostDlg, explorerCtrlID, DISPID_PROPERTYCHANGE, CBrowserHostDlg::Event_PropertyChange, VTS_BOOL VTS_BOOL)
	END_EVENTSINK_MAP()
